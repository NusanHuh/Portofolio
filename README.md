...
bun x sv@0.17.0 create --template minimal --types ts --add prettier eslint vitest="usages:component,unit" tailwindcss="plugins:typography,forms" sveltekit-adapter="adapter:node" --install bun .
```
...
>>>>>>> 186347bc9aa1010bc1739f8d1851006c3be34993
